...
export const MODULE_REGISTRY: AppModule[] = ([
  ...
  // FIRM OPS
  {
    ...
    route: '/firm/staff',
    shortcuts: [
      { label: 'Dashboard', route: '/firm/staff?section=dashboard', iconName: 'heroSquares2x2Solid' },
      { label: 'Staff Directory', route: '/firm/staff?section=directory', iconName: 'heroUserGroupSolid' },
      { label: 'Add Staff', route: '/firm/staff?section=add', iconName: 'heroPlusSolid' },
      { label: 'Roles & Permissions', route: '/firm/staff?section=roles', iconName: 'heroShieldCheckSolid' },
      { label: 'Client Assignment', route: '/firm/staff?section=assignments', iconName: 'heroIdentificationSolid' },
      { label: 'Task Management', route: '/firm/staff?section=tasks', iconName: 'heroClipboardDocumentCheckSolid' },
      { label: 'Attendance', route: '/firm/staff?section=attendance', iconName: 'heroClockSolid' },
      { label: 'Leave Management', route: '/firm/staff?section=leave', iconName: 'heroCalendarDaysSolid' },
      { label: 'Payroll', route: '/firm/staff?section=payroll', iconName: 'heroBanknotesSolid' },
      { label: 'Performance', route: '/firm/staff?section=performance', iconName: 'heroChartBarSolid' },
      { label: 'Documents', route: '/firm/staff?section=documents', iconName: 'heroFolderOpenSolid' },
      { label: 'Activity Logs', route: '/firm/staff?section=logs', iconName: 'heroClipboardDocumentListSolid' },
    ],
    pinned: true,
  },
