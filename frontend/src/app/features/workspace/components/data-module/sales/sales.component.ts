...
@Component({
  ...
  styles: [`
    ...
    .sa-card::before {
      background: linear-gradient(180deg, var(--accent, #1d4ed8), rgba(29, 78, 216, .18));
      content: '';
      inset: 0 auto 0 0;
      position: absolute;
      width: 3px;
    ...
    :host-context(.dark) .sa-card {
      background: var(--ad-card-bg, #10213a);
      box-shadow: none;
    }
    :host-context(.dark) .sa-input {
      background: #14243c;
      border-color: var(--ad-card-border, #263b59);
